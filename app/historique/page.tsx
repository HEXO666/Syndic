...
export default function HistoriquePage() {
  ...
  return (
    <ModernLayout title="Historique">
      <div className="p-6">
        <h1 className="text-3xl font-bold mb-4">Historique des activites</h1>
        <p className="text-slate-600">Consultez l'historique des operations</p>
      </div>
    </ModernLayout>
  )
}
